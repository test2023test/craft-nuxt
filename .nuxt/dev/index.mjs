globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ruslanbaroev/Projects/craft-nuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _I1jdDyvDig = (function(nitro) {
...
const _lazy_z9or0C = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_z9or0C, lazy: true, middleware: false, method: undefined },
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"src":"/js/main.js"},{"src":"/js/vendor.js","body":true},{"src":"https://api-maps.yandex.ru/2.1/?apikey=53f8fad6-a29a-4bf6-81e9-8d6aad62eed3&lang=ru_RU"},{"src":"/js/YaMap.js","body":true}],"noscript":[]};
...
const getClientManifest = () => import('file:///Users/ruslanbaroev/Projects/craft-nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/ruslanbaroev/Projects/craft-nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
