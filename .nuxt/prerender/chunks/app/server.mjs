import { watch, reactive, inject, hasInjectionContext, getCurrentInstance, createApp, useSSRContext, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, computed, ref, h, Suspense, Transition } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/unctx/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1, RouterView } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/ufo/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/ruslanbaroev/Projects/craft-nuxt/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/agreement-91cf12b1.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/index-648417a0.mjs').then((m) => m.default || m)
  },
  {
    name: "lk",
    path: "/lk",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/lk-b8d49537.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./assets/login-203c814c.mjs').then((m) => m.default || m)
  },
  {
    name: "where-to-buy",
    path: "/where-to-buy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/where-to-buy-916d627c.mjs').then((m) => m.default || m)
  },
  {
    name: "winners",
    path: "/winners",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/winners-1b7fda41.mjs').then((m) => m.default || m)
  }
];
...
const userModule = {
  ...
  actions: {
    async fetchPhone({ getters, commit }, phoneNumber) {
      ...
      return await fetch(
        getters.apiUrl + "/send-phone-code/",
        {
          method: "POST",
          headers: {
    ...
    async fetchUserCode({ getters }, { phone, code }) {
      return await fetch(
        getters.apiUrl + "/check-phone-code/",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json;charset=utf-8"
    ...
    async sendPhoneNumber({ getters, commit, dispatch }, phoneNumber) {
      await dispatch("fetchPhone", phoneNumber);
    ...
    async loginInToSystem({ getters, commit }) {
      fetch(getters.apiUrl + "/user/?token=" + localStorage.getItem("userToken")).then(async (response) => {
    ...
    async getSticker({ commit, getters }) {
      await fetch(getters.apiUrl + "/stickers/?token=" + localStorage.getItem("userToken")).then(async (response) => {
  ...
  getters: {
    ...
    apiUrl: () => (/* @__PURE__ */ useRuntimeConfig()).public.API_BASE_URL,
    getStikerCount(store2) {
      return store2.stikerList.reduce((result, item) => {
...
const layouts = {
  default: () => import('./assets/default-d630a0e4.mjs').then((m) => m.default || m),
  login: () => import('./assets/login-cd3fbde1.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/error-404-694adae2.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/error-500-40dac4f1.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/island-renderer-ace2bb41.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useRuntimeConfig as a, useRouter as b, createError as c, navigateTo as n, server as s, useStore as u };
